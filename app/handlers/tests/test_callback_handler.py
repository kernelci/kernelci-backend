...
class TestCallbackHandler(TestHandlerBase):
    ...
    def test_get(self):
        headers = {"Authorization": "foo"}
        response = self.fetch(
            "/callback/lava/test", method="GET", headers=headers)
    ...
    def test_delete(self):
        headers = {"Authorization": "foo"}
        response = self.fetch(
            "/callback/lava/test", method="DELETE", headers=headers)
    ...
    def test_post_no_token(self):
        response = self.fetch("/callback/lava/test", method="POST", body="")
    ...
    def test_post_token_wrong_content(self):
        ...
        response = self.fetch(
            "/callback/lava/test", method="POST", body="", headers=headers)
    ...
    def test_post_token_missing_query_parameter(self):
        ...
        response = self.fetch(
            "/callback/lava/test", method="POST", body=body, headers=headers)
