...
"""The RequestHandler to handle '/count/distinct' requests."""
...
class CountDistinctHandler(hbase.BaseHandler):
    """Handle the '/count/distinct' URL resources."""

    def __init__(self, application, request, **kwargs):
        self.resource = None
        super(CountDistinctHandler, self).__init__(
